<?php
/*
   Plugin Name: Météo - SODEXAM -COTE D'IVOIRE
   Version: 1.0.0
   Author: Christian KIMOU
   Author URI: https://chrisdev.com/
   Description: Extension pour consulter la météo en Cote d'ivoire
   Text Domain: meteo
   License: GPLv3
*/
